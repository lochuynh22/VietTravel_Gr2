...
Vào tab Network
Thực hiện một action (ví dụ: xem danh sách tours)
Kiểm tra request đến http://localhost:4000/api/... thành công
4. Test đăng nhập
Vào trang đăng nhập
Thử đăng nhập với:
Email: linh@demo.com
...
Kiểm tra lại các bước setup
Xem phần Troubleshooting
Kiểm tra console logs (backend và frontend)
Kiểm tra MongoDB connection
Xem file PROJECT_STATUS.md để biết trạng thái dự án
